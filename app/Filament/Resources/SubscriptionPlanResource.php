    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            TextInput::make('tagline')
                ->label('Tagline / Badge')
                ->maxLength(60)
                ->helperText('Badge singkat di card, mis. "Paling Hemat" atau "Semua Program".'),
            ...
            Repeater::make('features')
                ...
                ->reorderable()
                ->helperText('Ditampilkan sebagai daftar centang di card langganan.'),
